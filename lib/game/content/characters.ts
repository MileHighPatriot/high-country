  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        seasons: ["fall", "winter"],
        minStanding: 1,
        text: "Silas has a blackened kettle and a look that has already spent Christmas. “Ice is a liar. You melt it. You don’t walk it. Men who walk it write their names on the bottom of the creek.”",
        choices: [
          {
            id: "heed",
            label: "Ask which saddle loads first",
            outcome: {
              text: "He draws in ash: the wind saddle, the chute, the ruin well. Some of it is spite. Some of it will keep you numbered among the living.",
              hours: 2,
              unlockLocation: "wind-saddle",
              extraAdd: "silas-map",
              standing: { id: "silas-crowe", delta: 1 },
              markDialogue: "silas-winter",
            },
          },
          {
            id: "wood",
            label: "Split his wood for a share of the kettle",
            outcome: {
              text: "You work. He talks. The kettle is beans and something that was meat. You eat and do not ask which year.",
              hours: 3,
              inventory: { firewood: 1 },
              meters: { hunger: 16, warmth: 10, energy: -10 },
              standing: { id: "silas-crowe", delta: 1 },
              markDialogue: "silas-winter",
            },
          },
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        id: "tomas-still",
        seasons: ["summer", "fall"],
        requiresExtra: "letter-to-taos",
        text: "Padre Tomás sees the paper in your shirt before you speak. “Still carrying. That is a kind of faith I did not order.” He has chile again. He always has chile.",
        choices: [
          {
            id: "keep",
            label: "Keep the letter. Eat.",
            outcome: {
              text: "He does not take it back. He feeds you and blesses the mule, which is not yours. “If you die, someone else will find her name. That is also a road.”",
              hours: 2,
              meters: { hunger: 20, thirst: 8 },
              standing: { id: "padre-tomas", delta: 1 },
              markDialogue: "tomas-still",
            },
          },
          {
            id: "return",
            label: "Give it back — you will not go down",
            outcome: {
              text: "He nods, no theater. The letter returns to the cassock. He still fills your skin. “Then live high. That is harder.”",
              hours: 1,
              inventory: { water: 1 },
              extraRemove: "letter-to-taos",
              standing: { id: "padre-tomas", delta: 1 },
              markDialogue: "tomas-still",
            },
          },
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        id: "hennepin-collect",
        seasons: ["fall", "winter"],
        requiresExtra: "company-debt",
        minStanding: 1,
        text: "Hennepin does not bother with the smile. “You ate our flour. The book has a season on it. Pelts, or I write you down as lost and the lost still owe.”",
        choices: [
          {
            id: "pay",
            label: "Pay three pelts and be rid of the page",
            outcome: {
              text: "He inks a line through your name as if it were a kindness. The flour is gone. So is the leash, if you believe ink.",
              hours: 1,
              inventory: { pelts: -3 },
              extraRemove: "company-debt",
              standing: { id: "hennepin", delta: 1 },
              markDialogue: "hennepin-collect",
            },
          },
          {
            id: "stall",
            label: "Stall. You need the hides",
            check: { trait: "savvy", dc: 14 },
            success: {
              text: "He allows a week that is not a week. “Winter is my clerk.” He leaves you the feeling of a hook still in the lip.",
              hours: 1,
              standing: { id: "hennepin", delta: -1 },
              markDialogue: "hennepin-collect",
            },
            fail: {
              text: "He takes a pelt off the top of your pack while talking. The book stays open.",
              hours: 1,
              inventory: { pelts: -1 },
              standing: { id: "hennepin", delta: -2 },
              markDialogue: "hennepin-collect",
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        id: "ned-later",
        minStanding: 2,
        text: "Ned has a grouse, held like a secret, and a cut on his thumb he is pretending is a trophy. “I can hunt. A little. You can have half if you don’t laugh.”",
        choices: [
          {
            id: "share",
            label: "Share the bird and show him the cut",
            outcome: {
              text: "You clean the thumb with snowmelt and meanness. He eats. After, he points out a deadfall blaze you had walked past twice.",
              hours: 2,
              inventory: { rations: 1 },
              unlockLocation: "cache-deadfall",
              standing: { id: "ned-calhoun", delta: 1 },
              markDialogue: "ned-later",
            },
          },
          {
            id: "senddown",
            label: "Tell him to go down before the passes close",
            outcome: {
              text: "He argues, then doesn’t. A boy in a bad coat becomes a speck. You keep the quieter camp and the whole grouse.",
              hours: 1,
              inventory: { rations: 1 },
              standing: { id: "ned-calhoun", delta: -1 },
              presentCharacter: null,
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        seasons: ["summer", "fall"],
        minStanding: 1,
        text: "Nawat has a strip of dried meat and a look that is almost a question. “You walked like a guest. Guests can eat. Then they leave before they think the park is a road.”",
        choices: [
          {
            id: "eat",
            label: "Eat and ask nothing",
            outcome: {
              text: "The meat is smoky and thin. He points you at a spring the maps do not have, then is grass again.",
              hours: 1,
              inventory: { water: 1, rations: 1 },
              standing: { id: "nawat", delta: 1 },
              markDialogue: "nawat-later",
            },
          },
          {
            id: "stay",
            label: "Ask if you may sit the afternoon",
            outcome: {
              text: "He does not say no. He also does not say yes. You sit at the edge until the light tilts, then go, which is the answer.",
              hours: 3,
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        seasons: ["winter"],
        minStanding: 1,
        text: "Jean-Baptiste has a hole in the pond ice the size of a hat and a song that has forgotten summer. “The church is locked,” he says. “I am still a bad parishioner.”",
        choices: [
          {
            id: "fish",
            label: "Fish the hole with him",
            check: { trait: "hands", dc: 13 },
            success: {
              text: "One dark trout, then the hole skins over. He splits it with a knife that has seen the Saskatchewan. You eat it before the fat sets.",
              hours: 3,
              inventory: { rations: 1 },
              meters: { warmth: -12, energy: -8 },
              standing: { id: "jean-baptiste", delta: 1 },
              markDialogue: "jb-winter",
            },
            fail: {
              text: "You lose a line and a glove’s worth of feeling. He hauls you back by the collar, still humming, which is unkind.",
              hours: 2,
          ...
          {
            id: "tobacco",
            label: "Share the willow tobacco and sit",
            outcome: {
              text: "The smoke is an idea of comfort. He talks about a sea he will not see. You do not have to believe him to stay warm an hour.",
              hours: 2,
              meters: { warmth: 8, energy: 4 },
              extraRemove: "willow-tobacco",
              standing: { id: "jean-baptiste", delta: 1 },
              markDialogue: "jb-winter",
            },
          },
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        seasons: ["winter"],
        minStanding: 1,
        text: "Martha’s well is a plug of ice. She is wrapping her hands in a rag that was a skirt. “If you came for water, the seep still moves. If you came to talk, I have potatoes that remember October.”",
        choices: [
          {
            id: "seep",
            label: "Fill at the seep and carry her bucket",
            outcome: {
              text: "Iron water, two skins, a potato the size of a child’s fist. She does not call it pay. You do not either.",
              hours: 2,
              inventory: { water: 2, rations: 1 },
              meters: { energy: -8, warmth: -6 },
              standing: { id: "martha-keene", delta: 1 },
              markDialogue: "martha-winter",
            },
          },
          {
            id: "stay",
            label: "Sit by the chimney crack and listen",
            outcome: {
              text: "She talks about a husband who went for salt and became weather. You keep the fire small, the way Gray Elk said. The ruin holds.",
              hours: 3,
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        seasons: ["fall", "winter"],
        minStanding: 1,
        text: "Hannah has tallow on her wrists and a look that inventories your ears. “If they’re still pink I have other work. If they’re not, sit. I am not asking twice.”",
        choices: [
          {
            id: "sit",
            label: "Sit. Pay in wood if you have it",
            outcome: {
              text: "She salves splits you had been ignoring. The sting is a receipt. You leave able to hold an axe without bleeding into the haft.",
              hours: 2,
              inventory: { firewood: -1 },
          ...
          {
            id: "ask",
            label: "Ask who she is still waiting on",
            outcome: {
              text: "“Amos thinks luck is a tool. Caleb knows better and follows him anyway.” She does not make it your problem. She already has.",
              hours: 1,
              standing: { id: "hannah-briggs", delta: 1 },
              markDialogue: "hannah-later",
            },
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        id: "peggy-pay",
        minStanding: 2,
        requiresExtra: "peggy-favor",
        text: "Peggy looks at your boots, then at your face. “You put food in my hole. I put food in yours. That’s the whole church. Don’t make a hymn of it.”",
        choices: [
          {
            id: "take",
            label: "Take the share",
            outcome: {
              text: "Jerky wrapped in a rag, and a pinch of powder in oiled cloth. She is already walking. The deadfall keeps both of your names, or neither.",
              hours: 1,
              inventory: { rations: 2, powder: 1 },
              extraRemove: "peggy-favor",
              standing: { id: "peggy-dunne", delta: 1 },
              markDialogue: "peggy-pay",
            },
          },
          {
            id: "leave",
            label: "Tell her to keep it for a worse week",
            outcome: {
              text: "She snorts, which is thanks. “Then don’t die stupid. I hate restocking for ghosts.”",
              hours: 1,
              standing: { id: "peggy-dunne", delta: 1 },
              markDialogue: "peggy-pay",
            },
